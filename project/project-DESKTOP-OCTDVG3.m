...
%         questionNum = 2;
    ...
    if questionNum == 1
        collision = part1(rob,qStart,[-0.9391, -2.5286, 1.4566, -0.3478 0 0],sphereCenter,sphereRadius);
        display(['this should be 1: ',int2str(collision)])
        collision = part1(rob,qStart,[0 -0.78 0 -1.5 0 0],sphereCenter,sphereRadius);
        display(['this should be 0: ',int2str(collision)])        
        collision = part1(rob,qStart,[0 -0.78 0 -0.1 0 0],sphereCenter,sphereRadius);
        display(['this should be 1: ',int2str(collision)])     
